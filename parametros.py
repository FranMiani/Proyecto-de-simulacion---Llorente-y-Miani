...
class FaseControlador(Enum):
    ...
    ESPERANDO_FIN_BOLSA = "ESPERANDO_FIN_BOLSA"
    DESVIADO = "DESVIADO"
...
class Params:
    # Actuador
    ACTUADOR_ERROR_MIN = -0.11
    ACTUADOR_ERROR_MAX = 0.11
    ...
    # Enfermero
    ENFERMERO_TIEMPO_RESP_BAJA_MIN = 30.0
    ENFERMERO_TIEMPO_RESP_BAJA_MAX = 90.0
    ENFERMERO_TIEMPO_RESP_CRITICA_MIN = 5.0
    ENFERMERO_TIEMPO_RESP_CRITICA_MAX = 30.0
    
    # Generador
    GENERADOR_CAUDAL_INICIAL = 100.0
    GENERADOR_TIEMPO_NUEVA_ORDEN = 60.0
