...
class Params:
    ...
    # Enfermero
    ENFERMERO_TIEMPO_RESP_BAJA_MIN = 1000.0
    ENFERMERO_TIEMPO_RESP_BAJA_MAX = 5000.0
    ENFERMERO_TIEMPO_RESP_CRITICA_MIN = 500.0
    ENFERMERO_TIEMPO_RESP_CRITICA_MAX = 2000.0
